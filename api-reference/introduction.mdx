...
| Executive Counts | Free |

All endpoints that return executive data support `role_types` (filter by role group), `status_filter` (`"current"`, `"former"`, or `"all"`), and `person_type` (`"physical"`, `"legal"`, or `"all"`).
