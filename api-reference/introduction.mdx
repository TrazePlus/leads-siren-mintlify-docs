...
| Search Executives | 1 credit per person returned |
| Mandataires | 1 credit per dirigeant returned |
| Enrich | Dynamic — based on records enriched |
| Enrich Siren | Dynamic — based on records enriched |
